...
public class ModelMapperConfig {
	...
	public ModelMapper modelMapper() {
		...
		// Skip ID field mapping to prevent matching DTO reference IDs (like productId,
		// policyId) to the entity primary key id.
		...
		modelMapper.typeMap(com.monocept.app.dto.UserRequestDto.class, com.monocept.app.model.User.class)
				.addMappings(mapper -> {
					...
					mapper.map(com.monocept.app.dto.UserRequestDto::getPhoneNumber,
							com.monocept.app.model.User::setPhoneNumber);
				});
